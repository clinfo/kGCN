...
/**
 * This is the model implementation of AddModality.
 ...
 * @author org.gcnk
 */
public class AddModalityNodeModel extends GCNNodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(AddModalityNodeModel.class);
     ...
     */
    protected AddModalityNodeModel() {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        final String scriptPath = Activator.getFile("org.gcnk.knime.nodes", "/py/add_modality.py").getAbsolutePath();
    	...
    	String modalityFile = getInPortFile("Modality File", inData[1]);

        String workDir = new File(datasetFile).getParent();

        String logFile = workDir + "/AddModality";
        String outFile = workDir + "/dataset";
