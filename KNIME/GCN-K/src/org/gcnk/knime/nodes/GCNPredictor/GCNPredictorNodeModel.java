...
/**
 * This is the model implementation of GCNPredictor.
 * Predict test dataset with model.
 *
 * @author org.gcnk
 */
public class GCNPredictorNodeModel extends GCNNodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(GCNPredictorNodeModel.class);
     ...
     */
    protected GCNPredictorNodeModel() {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        String logFile        = workDir + "/GCNPredictor.log";
        String configFile     = workDir + "/test.json";
        String predictionFile = workDir + "/prediction.jbl";
        ...
        String load_model = modelFile.replaceAll("\\\\", "/");
        ...
        pw.println("    \"load_model\"          : \"" + load_model           + "\",");
        pw.println("    \"prediction_data\"     : \"./prediction.jbl\"");
        pw.println("}");
        pw.close();
        ...
        allColSpecs[1] = new DataColumnSpecCreator("Prediction File", StringCell.TYPE).createSpec();
...

        {
	        ...
	        cells[1] = new StringCell(predictionFile);
