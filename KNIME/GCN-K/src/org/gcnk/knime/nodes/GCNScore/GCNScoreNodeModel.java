...
/**
 * This is the model implementation of GCNScore.
 * Calculate scores from output of GCNPredictior
 *
 * @author org.gcnk
 */
public class GCNScoreNodeModel extends GCNNodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(GCNScoreNodeModel.class);
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        final String scriptPath = Activator.getFile("org.gcnk.knime.nodes", "/py/gcn_score.py").getAbsolutePath();
        ...
        String logFile = workDir + "/GCNScore.log";
        String outFile = workDir + "/result_predict/prediction.csv";
        
        String[] Command = { pythonPath, scriptPath, 
        		"--prediction_data", predictionFile, 
        		"--output", outFile};
