 ...
 * @author org.gcnk
 */
public class GraphExtractorNodePlugin extends Plugin {
    // The shared instance.
    private static GraphExtractorNodePlugin plugin;

    /**
     * The constructor.
     */
    public GraphExtractorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GraphExtractorNodePlugin getDefault() {
        return plugin;
    }
